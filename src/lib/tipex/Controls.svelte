		...
		<div class="tipex-basic-controller-wrapper">
			...
			>
				<svg class="tipex-icon" fill="currentColor" viewBox="0 0 16 16">
					...
					/>
					<path
						d="M11.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L8.5 10.293l2.646-2.647a.5.5 0 0 1 .708 0z"
					/>
				</svg>
			</button>
				...
				{#if copySuccess}
					<svg class="tipex-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14">
						...
						>
							...
							<path
								d="M9.75 1.5h1.5a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1h-8.5a1 1 0 0 1-1-1v-10a1 1 0 0 1 1-1h1.5"
							/>
